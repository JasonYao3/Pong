...
public class MainMenu extends JFrame implements Runnable {
    ...
    public MainMenu() {
        ...
        this.startGame = new Text("Start Game", new Font("Times New Roman", Font.PLAIN, 40),
                Constants.SCREEN_WIDTH / 2.0 - 70.0, Constants.SCREEN_HEIGHT / 2.0, Color.WHITE);
        this.exitGame = new Text("Exit", new Font("Times New Roman", Font.PLAIN, 40),
                Constants.SCREEN_WIDTH / 2.0 - 70.0, Constants.SCREEN_HEIGHT / 2.0 + 60, Color.WHITE);
        this.pong = new Text("Pong", new Font("Times New Roman", Font.PLAIN, 100),
                Constants.SCREEN_WIDTH / 2.0 - 70.0, 200, Color.WHITE);
